...
/*:
 ...
 Have you ever experienced that the alert comming from an ambulence increasing and decreasing as it passes by? This is called [doppler effect](glossary://doppler%20effect).
 ...
 *Note: the speed is presented in a vector of the change in direction per second. (0,0,2) means it will move 2 units on z-axis per second.*
