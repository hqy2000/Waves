...
/*:
 ...
 Now let us combine the tuning fork and the oscilloscope together. Clicking on the fork will result in a wave being produced, and the wave will be shown on the oscilloscope as a result.
 ...
 You may wonder why the amplitude of the actual wave is constantly decreasing. That is due to the vibration of the fork is decreasing as a result of air resistance and many other effects.
 */
