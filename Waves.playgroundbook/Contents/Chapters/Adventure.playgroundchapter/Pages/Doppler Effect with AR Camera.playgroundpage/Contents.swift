 ...
 *Note: the speed is presented in a vector of the change in direction per second. (0,0,2) means it will move 0 units on the x-axis, 0 units on the y-axis and 2 units on the z-axis per second.*
